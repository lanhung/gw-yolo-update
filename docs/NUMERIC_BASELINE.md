...
1. Continue the nested curve at 500, 1k, 2k, 5k, and 10k independent scenes with at least three
   seeds; do not infer an asymptote from two points.
2. Vectorize or cache dependency-free transforms: the 250-scene, 20-epoch run took 331 seconds and
   was generator-bound relative to the GPU.
